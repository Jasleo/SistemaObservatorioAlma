 ...
 * @author dumbo
 */
@WebServlet(urlPatterns = {"/crearCuerpoCeleste.do"})
public class CrearCuerpoCelesteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            d.crearCuerpoCeleste(nuevoCuerpoCeleste);
            
            response.sendRedirect("menu.jsp");
            
        } catch (SQLException ex) {
            Logger.getLogger(CrearCuerpoCelesteServlet.class.getName()).log(Level.SEVERE, null, ex);
